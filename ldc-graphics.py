...
import time,math
spi = SPI(1, 8000000,  sck=Pin(18), mosi=Pin(23), miso=None)       #Determine the transfer speed in Hz, fixed MOSI and CLCK
tft=TFT(spi,4,5,2)
tft.initr()
tft.rgb(True)
tft.rotation(1) # 0-3
tft.fill(TFT.BLACK);
tft.rect((1, 2), (159,128),TFT.YELLOW)

tft.rect((50,60), (30,30), TFT.RGB3)
# tft.fillrect((90, 30), (30,30), TFT.RED)
#tft.circle((70, 67 ),22, TFT.YELLOW)
#tft.fillcircle((70, 67), 20, TFT.GREEN)
#tft.rect((1, 2), (159,128),TFT.YELLOW)
#tft.line((4,50) , (159,20 ), TFT.GREEN)
